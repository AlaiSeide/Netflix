...
def lista_filmes_recentes(request):
    ...
    # Buscando todos os filmes no banco de dados, ordenando-os em ordem decrescente de data de criação e pegando os 8 primeiros
...
def lista_filmes_emalta(request): # Definindo a função lista_filmes_emalta que recebe um objeto request como parâmetro
    # Buscando todos os filmes no banco de dados, ordenando-os em ordem decrescente de visualizações e pegando os 8 primeiros
